    ...
    public class D_MovimientoCuenta
    {
        public DataTable ListadoMV_cuentaGenerales(string cTexto)
        {
            ...
            try
            {
                ...
                OracleCommand Comando = new OracleCommand("SELECT*FROM V_MOVIMIENTO_CUENTA WHERE NOMBRE like '" + cTexto + "' ", SqlCon);
        ...
        public string GuardarMV_cuenta(int nOpcion, E_MovimientoCuenta oCl)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                OracleCommand Comando = new OracleCommand("USP_GuardarMovimientoCuenta", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("nOpcion",         OracleDbType.Int32).Value = nOpcion;
                Comando.Parameters.Add("nId_MV_Cuenta",   OracleDbType.Int32).Value = oCl.ID_MV_CUENTA;
